...
namespace DesignPatterns._3.Behavioural.Observer.Suscribers
{
    ...
    /// </summary>
    public class Tweeter2 : IObserver
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Tweeter2"/> class
        /// <paramref name="globantNews"/>GlobantNews instance
        /// </summary>
        public Tweeter2(GlobantNews globantNews)
        {
        ...
        public void Notify()
        {
            Console.WriteLine($"From Tweeter2: News: {_globantNews.NewsInfo}");
        }
    }
}